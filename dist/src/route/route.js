...
/* ================= SERVICE ================= */
router.post("/createService", ServiceController_1.createService);
router.get("/getServices", ServiceController_1.getServices);
router.get("/getServiceById/:id", ServiceController_1.getServiceById);
router.put("/updateService/:id", ServiceController_1.updateService);
router.delete("/deleteService/:id", ServiceController_1.deleteService);
